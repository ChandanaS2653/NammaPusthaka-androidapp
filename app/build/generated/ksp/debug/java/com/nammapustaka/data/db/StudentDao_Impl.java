...
public final class StudentDao_Impl implements StudentDao {
  ...
  public StudentDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfStudent = new EntityInsertionAdapter<Student>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `students` (`id`,`name`,`className`,`totalPagesRead`) VALUES (nullif(?, 0),?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(4, entity.getTotalPagesRead());
      }
    };
    this.__updateAdapterOfStudent = new EntityDeletionOrUpdateAdapter<Student>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `students` SET `id` = ?,`name` = ?,`className` = ?,`totalPagesRead` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public LiveData<List<Student>> getAllStudentsRanked() {
    final String _sql = "SELECT * FROM students ORDER BY totalPagesRead DESC";
      ...
      public List<Student> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Student(_tmpId,_tmpName,_tmpClassName,_tmpTotalPagesRead);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Student call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final int _tmpTotalPagesRead;
            _tmpTotalPagesRead = _cursor.getInt(_cursorIndexOfTotalPagesRead);
            _result = new Student(_tmpId,_tmpName,_tmpClassName,_tmpTotalPagesRead);
          } else {
            _result = null;
          }
          return _result;
