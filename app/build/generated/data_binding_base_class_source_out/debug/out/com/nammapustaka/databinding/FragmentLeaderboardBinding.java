...
public final class FragmentLeaderboardBinding implements ViewBinding {
  ...
  private FragmentLeaderboardBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView recyclerLeaderboard) {
  ...
  public static FragmentLeaderboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLeaderboardBinding((LinearLayout) rootView, recyclerLeaderboard);
    }
